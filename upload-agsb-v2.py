...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "nihaoya9527"         # 用户名
UUID = "81a04e27-544e-4a7a-87f6-c5eb60cb66c2"                     # UUID，留空则自动生成
PORT = 49523                   # Vmess端口，留空或0则自动生成
DOMAIN = "agsb.nihao.ggff.net"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiOTRlNGEyMWVhMmIyODY4NTc3YjE3Yjg3ZDkwNjFmZGQiLCJ0IjoiMWUxYTdiMDAtYTRhOC00YmJiLTg5N2UtODEwMGQ0YTIyYzhiIiwicyI6Ik1XSTFNV1JqTURRdE9HVmpNQzAwWVRoa0xUazJOell0TTJFelpHSTJNR1psTkRFMiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
